...
import { NumberField, CheckboxField, Submit } from '@redwoodjs/forms'
...
const ContractPricing = ({ formState, nextStep, formValues }) => {
        ...
        <div className="md:col-span-1">
          <div className="px-4 sm:px-0">
            ...
            <p className="mt-1 text-sm text-gray-600">
              ...
              Miles. Select from the available Terms and Conditions or create a
              new one.
            </p>
            <button
      ...
      <div className="mt-10 md:grid md:grid-cols-3 md:gap-6">
        <div className="md:col-span-1">
          <div className="px-4 sm:px-0">
            ...
            <p className="mt-1 text-sm text-gray-600">
              For each of the terms and conditions checked above, assign a price
              that the contract at this term and condition will be sold for.
            </p>
          </div>
        </div>
        <div
