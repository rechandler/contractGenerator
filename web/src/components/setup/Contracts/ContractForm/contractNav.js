        ...
        {formState.steps.map((step, stepIdx) => (
          <li key={step.name} className="relative md:flex-1 md:flex">
            {formState.currentStep === step.id ? (
              <a onClick={() => formNav(step.id)} className=" cursor-pointer px-6 py-4 flex items-center text-sm font-medium" aria-current="step">
                ...
                <span className="ml-4 text-sm font-medium text-cyan-600">{step.name}</span>
              </a>

            ) : step.completed ? (
              <a onClick={() => formNav(step.id)}  className="cursor-pointer group flex items-center w-full">
              ...
              <a onClick={() => formNav(step.id)}  className="cursor-pointer group flex items-center">
                <span className="px-6 py-4 flex items-center text-sm font-medium">
