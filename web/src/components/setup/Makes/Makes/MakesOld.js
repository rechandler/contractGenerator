          ...
          <div className="md:col-span-1">
            <div className="px-4 sm:px-0">
              ...
              <p className="mt-1 text-sm text-gray-600">
                Select a Manufacturer below to assign contract categories to
                models
              </p>
                ...
                {({ open }) => (
                  <>
                    ...
                    <div className="mt-5 relative">
                      <Listbox.Button className="bg-white relative w-full border border-gray-300 rounded-md shadow-sm pl-3 pr-10 py-2 text-left cursor-pointer focus:outline-none focus:ring-1 focus:ring-cyan-500 focus:border-cyan-500 sm:text-sm">
