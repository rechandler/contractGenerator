          ...
          <div className="relative flex flex-wrap items-center justify-center lg:justify-between">
            ...
            <div className="hidden lg:ml-4 lg:flex lg:items-center lg:py-5 lg:pr-0.5">
              ...
              <div className="ml-4 relative flex-shrink-0">
                <div>
                  <button type="button" onClick={openSidebar} className="bg-white rounded-full flex text-sm ring-2 ring-white ring-opacity-20 focus:outline-none focus:ring-opacity-100" id="user-menu" aria-haspopup="true">
              ...
              <div className="lg:grid lg:grid-cols-3 lg:gap-8 lg:items-center">
                ...
                <div className="hidden lg:block lg:col-span-2">
                  <nav className="flex space-x-4 text-cyan-100">
                    ...
                    <NavLink to={routes.contractSetup()} activeClassName="text-white" className="text-sm font-medium rounded-md bg-white bg-opacity-0 px-3 py-2 hover:bg-opacity-10">
                      Contract Setup
                    </NavLink>
                  </nav>
                </div>
